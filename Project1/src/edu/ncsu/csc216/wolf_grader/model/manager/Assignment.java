...
public class Assignment {
     ...
     * @param assignmentName name to set
     */
    ...
    /**
     * Sets the assignment category.
     * @param category category to set
     */
    public void setAssignmentCategory(String category) {
    ...
    /**
     * Sets the max points for this assignment.
     * @param maxPoints max points to set
     */
     ...
     * Throws IllegalArgumentException if a submission with the same id already exists.
     ...
     * Does nothing if no submission with that id exists.
    ...
    /**
     * Returns the string representation of the assignment for file save operations.
