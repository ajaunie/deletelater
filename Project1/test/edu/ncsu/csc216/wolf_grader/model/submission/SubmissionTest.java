...
public class SubmissionTest {
    ...
    /**
     * Tests full constructor rejects null grader (null is not the same as empty string).
     */
    @Test
    public void testFullConstructorNullGrader() {
        assertThrows(IllegalArgumentException.class,
                () -> new Submission(0, "Upload", "Oliver Grant", "ogrant", false, "Not Done", false, null, ""));
    }

    /**
     * Tests full constructor rejects null grade (null is not the same as empty string).
     */
    @Test
    public void testFullConstructorNullGrade() {
        assertThrows(IllegalArgumentException.class,
                () -> new Submission(0, "Upload", "Oliver Grant", "ogrant", false, "Not Done", false, "", null));
    }

    /**
     * Tests full constructor rejects both null grader and null grade simultaneously.
     */
    @Test
    public void testFullConstructorNullGraderAndGrade() {
        assertThrows(IllegalArgumentException.class,
                () -> new Submission(0, "Upload", "Oliver Grant", "ogrant", false, "Not Done", false, null, null));
    }

    /**
     * Tests that the full constructor rejects null or empty names.
     */
    @Test
     ...
     * Also verifies grader is cleared when returning to Upload.
     */
    @Test
